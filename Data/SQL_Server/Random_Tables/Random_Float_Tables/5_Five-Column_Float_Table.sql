/*
	This query creates a five-column table with random float values, including both positive and negative numbers.
...
BEGIN
	...
	VALUES (
		...
		(2 * ROUND(RAND(), 0) - 1) * @column_scale_parameter_4 * RAND(),
		(2 * ROUND(RAND(), 0) - 1) * @column_scale_parameter_5 * RAND()
	)
